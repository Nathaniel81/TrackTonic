"""
URL patterns for the core app of the Django application.

This module contains the URL patterns that are used to route different requests to the corresponding views.
"""
...
urlpatterns = [
    ...
    path('liked-songs/<str:pk>', views.liked_songs, name='liked-songs'),
