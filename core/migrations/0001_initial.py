# Generated by Django 4.2.6 on 2023-10-21 12:50
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cover', models.ImageField(blank=True, help_text='.jpg, .png, .jpeg, .gif, .svg supported', null=True, upload_to=core.models.user_dir)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('song_name', models.CharField(help_text='.mp3 supported only', max_length=40)),
